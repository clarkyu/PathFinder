...
| 🗺️ **决策** | 我去哪里 | 方向池（候选院校+专业）、决策平衡单（六维加权打分 + 综合排序）、冲·稳·保梯度归档与填报避坑提醒 | 金树人平衡单、阳光志愿冲稳保、教育部市场预警 |
| ⋯ **更多** | 其他支持 | 家长专区（自主支持型教养）、知识库（22 张理论卡片）、身份与阶段设置、数据导出/导入、关于与声明 | 自我决定理论、Marcia 早闭警示、全部理论体系 |
